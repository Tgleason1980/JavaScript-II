...
let largeShirts = runners.filter(function(runnerLg){
  return runnerLg.shirt_size == "L";
});
console.log(largeShirts);

// ==== Challenge 4: Use .reduce() ====
// The donations need to be tallied up and reported for tax purposes. Add up all the donations into a ticketPriceTotal array and log the result
let ticketPriceTotal = runners.reduce(function(donations, price){
return donations + price.donation;
},0);
...
// Problem 1
// Need to find the information on runner 29

let runner29 = runners.filter(function(runner){
  return runner.id == 29;
});
console.log(runner29);

// Problem 2
// find last name and email to all runners
...
runners.forEach(function(array){
 lName = array.last_name;
 eMail = array.email;
 nameEmail.push(lName);
 nameEmail.push(eMail);
});
console.log(nameEmail);

// Problem 3
// map for company names of runners
let company = runners.map(function(runner) {
